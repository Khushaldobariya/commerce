        ...
        <section id="appointment" className="appointment d-flex">
            <div className="container">
                <div className='section-title'>
                    {
                        reset ?
                            <h2 className='centerr my-4'>Reset Password</h2> :
                            userType === 'Login' ? <h2 className='centerr my-4'>Login</h2> : <h2 className='centerr my-4'>Signup</h2>
                    }
                </div>
                                ...
                                }
                                {
                                    reset ?
                                        <div className="text-center">
                                           <p> <button className="btn btn-primary btn-block py-3 px-5"type="submit">Forgot password</button></p>
                                        </div>
                                        :
                                        userType === 'Login' ?
                                            <div className="text-center">
                                                <button className="btn btn-primary btn-block py-3 px-5"type="submit">Login</button><br></br>
                                            </div> :
                                            <div className="text-center">
                                                <button className="btn btn-primary btn-block py-3 px-5 fs-3" type="submit">signup</button>
                                            </div>
                                }
                                {
                                    reset === true ? 
